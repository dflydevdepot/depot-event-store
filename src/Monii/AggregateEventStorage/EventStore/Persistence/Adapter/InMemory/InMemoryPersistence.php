...
class InMemoryPersistence implements Persistence
{
    ...
    public function commit(
        ...
        foreach ($eventEnvelopes as $eventEnvelope) {
            ...
            $record->event = $this->eventSerializer->serialize($aggregateType, $eventEnvelope->getEvent());
            $record->metadata = $this->metadataSerializer->serialize($aggregateType, $eventEnvelope->getMetadata());
        }
    }
}
